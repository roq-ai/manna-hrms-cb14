        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Onboarding Status" text={data?.onboarding_status} />

                <FormListItem label="Probation Status" text={data?.probation_status} />

                <FormListItem label="Exit Status" text={data?.exit_status} />

...
export function EmployeeListPage(props: EmployeeListPageProps) {
  ...
  const columns: ColumnType[] = [
    { id: 'onboarding_status', header: 'Onboarding Status', accessorKey: 'onboarding_status' },
    { id: 'probation_status', header: 'Probation Status', accessorKey: 'probation_status' },
    { id: 'exit_status', header: 'Exit Status', accessorKey: 'exit_status' },
